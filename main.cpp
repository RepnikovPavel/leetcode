...
// void deep_search(TreeNode* Node){
...
// void swap_childs_and_go(TreeNode* node){
//     if(node==nullptr){
//         return;
//     }
...
//     node->right = tmp;
//     swap_childs_and_go(node->left);
//     swap_childs_and_go(node->right);
// }

// TreeNode* invertTree(TreeNode* root) {
//     TreeNode* tmpptr = root;
//     // swap pointers on each level of tree and thats all you need.
//     swap_childs_and_go(root);
//     return root;
// }

// int count_and_go(TreeNode* node, int cnt){
//     if(node==nullptr){
//         return cnt-1;
//     }
//     int left_path_size = count_and_go(node->left, cnt+1);
//     int right_path_size = count_and_go(node->right, cnt+1);
//     return left_path_size>right_path_size?left_path_size:right_path_size;
// }

// int maxDepth(TreeNode* root) {
//     return count_and_go(root,1);
// }

// int count_and_go(TreeNode* node,int* max){
//     if(node == nullptr){
//         return 1;
//     }
//     int left_path_size = count_and_go(node->left, max);
//     int right_path_size = count_and_go(node->right, max);
//     int tmp_max = *(max);
//     *(max) = tmp_max>(left_path_size+right_path_size)?tmp_max:(left_path_size+right_path_size);
//     return 1 + (left_path_size>right_path_size?left_path_size:right_path_size);
// }

// int diameterOfBinaryTree(TreeNode* root) {
//     int tmp =0;
//     int* max = &tmp;
//     count_and_go(root, max);
//     // number of edges is number of nodes minus one
//     return (*max)-2;
// }

// int walk_down(TreeNode* node, int buff){
//     if(node == nullptr){
//         return 0;
//     }
//     if(buff==-1){
//         return -1;
//     }
//     int left_height = walk_down(node->left, buff);
//     int right_height = walk_down(node->right, buff);
